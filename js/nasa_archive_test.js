        ...
        if (this.readyState === 4 && this.status === 200) {
            ...
            for (var i = 0; i < data.length; i++) {
                if (data[i].media_type == "image") {
                    ...
                    dataObject.id = data[i].date;
                    dataObject.src = data[i].url;
                    dataObject.alt = data[i].title;
                    dataObject.exp = data[i].explanation;
                    dataObject += data[i];
                }
            }
