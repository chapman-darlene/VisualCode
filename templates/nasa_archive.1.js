...
function moreImagesTwo(data) {
    console.log(data);
    for (var i = 0; i <= 9; i++) {
        document.getElementById('img' + i).src = data[i].date;
        document.getElementById('img' + i).alt = data[i].title;
        document.getElementsByClassName('fav-title').innerHTML = data[i].title;
        document.getElementsByClassName('fav-date').innerHTML = data[i].date;
        document.getElementsByClassName('fav-exp').innerHTML = data[i].exp;
    }
}
/*
function addInfo() {
